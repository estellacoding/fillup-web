...
- [ ] 2. 實作 User Profile 資料模型

- [ ] 2.1 建立 User Profile 介面與相關型別
...
- [ ] 3. 實作 Water Record 資料模型

- [ ] 3.1 建立 Water Record 介面
...
- [ ] 4. 實作 Daily Progress 資料模型

- [ ] 4.1 建立 Daily Progress 介面
...
- [ ] 5. 實作 Achievement 資料模型

- [ ] 5.1 建立 Achievement 介面
